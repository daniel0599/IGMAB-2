...
%>
	...
	<div class="row">
		...
		<!-- INICIO DEL FORMULARIO PARA AGREGAR UNA OPCION -->
		...
		<div id="frm-agrega" class="box">
				...
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<div class="form-group">
							<label class="col-sm-6 control-label">Nueva Opción:</label>
							<div class="col-sm-6">
								<input type="text" class="form-control"
									placeholder="Ej. Gestión de citas, consultas" data-toggle="tooltip"
									data-placement="bottom" id="opcionNuevo" name="opcion"
									title="la opcion es requerida" required />
							</div>
						</div>
			...
			<!-- FIN DEL FORMULARIO PARA AGREGAR UNA NUEVA OPCION -->
			
			<!-- INICIO DE FORMULARIO PARA EDITAR UNA OPCION -->
						...
						<div class="col-sm-6">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control"
									placeholder="Ej. Gestión de citas, consultas" data-toggle="tooltip"
									data-placement="bottom" id="opcionEditar" name="opcion"
									title="La opcion es requerida" required />
							</div>
						</div>
		...
		<!-- FIN DEL FORMULARIO EDITAR UNA OPCION -->
						...
						<tr>
							...
							<td><button id="btnIdEliminar"
								...
								<button id='btnIdActualizar'
									onClick="cargarDatos(this.value, '<%=rs.getString("Opcion")%>');"
									value=<%=rs.getInt("opcionId")%> class="btn btn-primary btn-label-left">
...
<script type="text/javascript">
	...
	function eliminarOpcion(idClicked) {
		var opcion = "";
		var fIdOpcion = idClicked;
		opcion = "eliminar";
	...
	function actualizarOpcion(idClicked) {
		var opcion = "";
		var fopcionId = idClicked;
		var fOpcionEditar = "";

		opcion = "actualizar";
		fOpcionEditar = $("#opcionEditar").val();
		$.ajax({
			url : "SlOpcion",
			type : "post",
			datatype : 'html',
			data : {
				'fopcionId' : fopcionId,
				'fOpcionEditar' : fOpcionEditar,
				'opcion' : opcion
			},
			success : function(data) {
				$("#opcionEditar").val(null);
				$('#frm-edita').fadeOut();
	...
	function cargarDatos(opcionId, opcion) {
		var fOpcionId = opcionId;
		var fOpcion = opcion;

		$('#btnEditar').val(fOpcionId);
		$('#opcionEditar').val(fOpcion);
		$('#frm-edita').fadeIn();
		$('#frm-agrega').fadeOut();
	}
